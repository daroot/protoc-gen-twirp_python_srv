...
type Echo interface {
	...
	Repeat(context.Context, *EchoRequest) (*EchoResponse, error)

	// Repeat the input multiple times
	RepeatMultiple(context.Context, *EchoMultiRequest) (*EchoResponse, error)
}
...
func (c *echoProtobufClient) Repeat(ctx context.Context, in *EchoRequest) (*EchoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "example.echo")
...
func (c *echoProtobufClient) RepeatMultiple(ctx context.Context, in *EchoMultiRequest) (*EchoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "example.echo")
	ctx = ctxsetters.WithServiceName(ctx, "Echo")
	ctx = ctxsetters.WithMethodName(ctx, "RepeatMultiple")
	out := new(EchoResponse)
...
func (c *echoJSONClient) Repeat(ctx context.Context, in *EchoRequest) (*EchoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "example.echo")
	ctx = ctxsetters.WithServiceName(ctx, "Echo")
	ctx = ctxsetters.WithMethodName(ctx, "Repeat")
	out := new(EchoResponse)
...
func (c *echoJSONClient) RepeatMultiple(ctx context.Context, in *EchoMultiRequest) (*EchoResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "example.echo")
	ctx = ctxsetters.WithServiceName(ctx, "Echo")
	ctx = ctxsetters.WithMethodName(ctx, "RepeatMultiple")
	out := new(EchoResponse)
...
const EchoPathPrefix = "/twirp/example.echo.Echo/"
...
func (s *echoServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/example.echo.Echo/Repeat":
		s.serveRepeat(ctx, resp, req)
		return
	case "/twirp/example.echo.Echo/RepeatMultiple":
		s.serveRepeatMultiple(ctx, resp, req)
		return
	default:
...
func (s *echoServer) serveRepeat(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *echoServer) serveRepeatJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Repeat")
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *EchoResponse and nil error while calling Repeat. nil responses are not supported"))
		return
	}
...
func (s *echoServer) serveRepeatProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Repeat")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *echoServer) serveRepeatMultiple(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveRepeatMultipleJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRepeatMultipleProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *echoServer) serveRepeatMultipleJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RepeatMultiple")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	defer closebody(req.Body)
	reqContent := new(EchoMultiRequest)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		err = wrapErr(err, "failed to parse request json")
		s.writeError(ctx, resp, twirp.InternalErrorWith(err))
	...
	func() {
		...
		respContent, err = s.RepeatMultiple(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *EchoResponse and nil error while calling RepeatMultiple. nil responses are not supported"))
		return
	}
...
func (s *echoServer) serveRepeatMultipleProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RepeatMultiple")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
